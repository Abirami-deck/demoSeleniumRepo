...
public void profiles() {
        ...
        useInstance.basicinformation();
        useInstance.basicname();
        useInstance.companysname();
        useInstance.domainname();
        useInstance.emailcontact();
        useInstance.phonenumber();
        useInstance.employees();
        useInstance.foundedon();
      //  useInstance.youraccount();
